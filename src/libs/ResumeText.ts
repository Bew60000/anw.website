...
export const experienceInfo = [
  {
    ...
    company: "Aware Technology Solutions corporation ltd",
    position: "Software Developer",
    skills: ["ReactJS", "TailwindCSS", "NextJS", "TypeScript"],
  },
  {
    start: "APR 2024",
    end: "JUN 2024",
...
export const educations = [
  ...
  },
  {
    yearStart: 2015,
    yearEnd: 2021,
    educationName: "Stree Thungsong School",
    faculty: "",
    department: "",
    school: "Lower & Upper Secondary Education",
    highSchool: "Science and Mathematics",
  },
];
